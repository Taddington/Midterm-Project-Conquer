...
public class SaveScript : MonoBehaviour
{
    ...
    public void Load()
    {
        if (PlayerPrefs.HasKey($"MoveSpeed{saveSlot}"))
        {
            ...
            GameObject.Find("Forward Vector").GetComponent<CharacterController>().enabled = false;
            ...
            else
            {
                ...
                GameObject.Find("Forward Vector").transform.position = player.GetPosition();
            }
            GetComponent<CharacterController>().enabled = true;
            GameObject.Find("Forward Vector").GetComponent<CharacterController>().enabled = true;
            player.SetLives(5);
