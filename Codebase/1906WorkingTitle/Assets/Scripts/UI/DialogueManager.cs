...
public class DialogueManager : MonoBehaviour
{
    ...
    {
        if (Input.GetKeyDown(KeyCode.Return) || CrossPlatformInputManager.GetButtonDown("Use Potion"))
        {
            enter = false;
            textIndex++;
            //Wait time for "Press Enter to continue" to pop up
        ...
        if (Input.GetKeyDown(KeyCode.RightArrow) || CrossPlatformInputManager.GetButtonDown("Pause"))
        {
            skip = true;
        }
    }
