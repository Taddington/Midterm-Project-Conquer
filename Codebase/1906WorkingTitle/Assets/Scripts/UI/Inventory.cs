...
public class Inventory : MonoBehaviour
{
    ...
    private void Update()
    {
        if (!isPaused)
        {
            if (weaponNode != null)
            {
                if (CrossPlatformInputManager.GetButtonDown("Next Weapon"))
                    CycleWeaponForward();
                if (CrossPlatformInputManager.GetButtonDown("Last Weapon"))
                    CycleWeaponBackward();
            }

            if (consumableNode != null)
            {
                if (CrossPlatformInputManager.GetButtonDown("Next Potion"))
                    CycleConsumableForward();
                if (CrossPlatformInputManager.GetButtonDown("Last Potion"))
                    CycleConsumableBackward();
            }

            if (CrossPlatformInputManager.GetButtonDown("Use Potion"))
            {
