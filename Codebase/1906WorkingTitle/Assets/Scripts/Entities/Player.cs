...
public class Player : MonoBehaviour
{
    ...
    private GameObject forwardDirection = null;
    #endregion
    ...
    void Start()
    {
        ...
        forwardDirection = GameObject.Find("Forward Vector");
    ...
    void Update()
    {
        if (!paused)
        {
            ...
            Vector3 relativePosition = forwardDirection.GetComponent<Transform>().position - transform.position;
            ...
            if (!isStunned)
            {
                ...
                if (CrossPlatformInputManager.GetButtonDown("Dash") && moveDirection != Vector3.zero)
                ...
                #region PlayerAttack
                if (CrossPlatformInputManager.GetButtonDown("Bullet 1") && inventory.GetBulletCount() >= 0)
                    bulletChoice = 1;
                if (CrossPlatformInputManager.GetButtonDown("Bullet 2") && inventory.GetBulletCount() >= 1)
                    bulletChoice = 2;
                if (CrossPlatformInputManager.GetButtonDown("Bullet 3") && inventory.GetBulletCount() >= 2)
                    bulletChoice = 3;
                if (CrossPlatformInputManager.GetButtonDown("Bullet 4") && inventory.GetBulletCount() >= 3)
                    bulletChoice = 4;
